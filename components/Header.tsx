...
const Header = () => {
  return (
    <header className="bg-white relative overflow-hidden pt-6">
      <div className="relative mx-auto max-w-[90rem] px-4 sm:px-6 lg:px-8">
        <div className="relative z-10 flex items-center justify-between">
          ...
          <a
            ...
            href="https://www.github.com/kaleabo/og-image-generator"
          >
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
            ...
            <span>
              Github<span className="sr-only sm:not-sr-only"> Repo</span>
            </span>
          </a>
        </div>
      </div>
